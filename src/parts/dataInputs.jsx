    ...
    <>
      ...
      <div>
            ...
            <div>
              ...
              <div className="grid">
                <div>
                  <label
                    htmlFor="repeater"
                    data-tooltip={toolTips.repeater}
                    data-placement="left"
                  >
                    <input
                      id="repeater"
            ...
            <article>
              <label htmlFor="dataSetName">
                ...
                <input
                  ...
                  onChange={(e) => props.handleChangeDataSetProperty(e, index)}
              ...
              >
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    props.handleDataXChange(e.target.value, index)
                  }
                ></textarea>
              </label>
              <label
              ...
              >
                ...
                <textarea
                  ...
                  onChange={(e) => {
                    props.handleChangeDataSetProperty(e, index)
        ...
        {/*
				...
				*/}
        <button className="secondary" onClick={props.handleAddAnotherData}>
          +
        </button>
      </div>
      <br />
        ...
        {chartTypes.map((chartType) => {
          return (
            <button
              ...
              className={
                chartType.type === props.settings[0].chartType ? 'active' : ''
              }
            >
              {chartType.name}
            </button>
